...
import "@lilyswapdex/exchange-contracts/contracts/lilyswap-core/interfaces/ILilyswapERC20.sol";
...
contract StakingRewards is ReentrancyGuard, Ownable {
    ...
    function stakeWithPermit(uint256 amount, uint deadline, uint8 v, bytes32 r, bytes32 s) external nonReentrant updateReward(msg.sender) {
        ...
        // permit
        ILilyswapERC20(address(stakingToken)).permit(msg.sender, address(this), amount, deadline, v, r, s);
